...
def init_args():
    ...
    parser.add_argument('-c', '--char_dict_path', type=str, default='./step_three_recognize_process/char_map/char_map.json',
                        help='The char dict file path. If it is None the char dict will be'
                             'generated automatically in folder dataset/char_dict')
...
if __name__ == '__main__':
    ...
    write_tfrecords(dataset_dir=args.dataset_dir, char_dict_path=args.char_dict_path,
        ...
        writer_process_nums = 10, dataset_flag=args.dataset_flag)
